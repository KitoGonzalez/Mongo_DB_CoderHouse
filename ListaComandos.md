...
```console
db.createUser({user: "pepe", pwd: "asd456", roles: [{role: "read", db: "ecommerce_CoderHouse"}]});
```

- Login del usuario creado anteriormente **Tengo ese Error**

```console
SyntaxError: Missing semicolon. (1:8)
> 1 | mongo -u "pepe" -p "asd456" --authenticationDatabase "read"
```
